...
embeddings = np.load("album_mood_final/backend/building_embedding_data/embeddings.npy")  # shape (N, D)

print("Loading metadata from embeddings_metadata.csv...")
df_emb = pd.read_csv("album_mood_final/backend/building_embedding_data/embeddings_metadata.csv")
